<nav x-data="{ open: false, mobileMenu: false }" class="fixed top-0 left-0 right-0 z-50 bg-white shadow-lg border-b border-gray-200">
    <head>
        ...
        <style>
            ...
            .mobile-menu .dropdown-content {
                padding-left: 1rem;
                margin-top: 0.5rem;
                border-left: 2px solid var(--primary-color, #FFA500);
            }
    ...
    </head>    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            <!-- Logo et Nom -->
            <div class="flex items-center">
                <a href="{{ route('home') }}" class="flex items-center mr-8">
                    <img src="{{ asset('images/logo-crefer.png') }}" alt="Logo CREFER" class="h-12 w-auto">
                </a>
            </div>
            <!-- Navigation Links -->
