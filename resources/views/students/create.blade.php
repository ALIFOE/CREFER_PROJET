...
<div class="container mx-auto px-4 py-8 max-w-md">
    <h1 class="text-3xl font-bold text-gray-900 mb-6">Ajouter un Étudiant</h1>
    ...
    <form method="POST" action="{{ route('students.store') }}" class="bg-white shadow rounded-lg p-6">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="date" name="date_of_birth" id="date_of_birth" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('date_of_birth') }}">
        </div>

        <div class="mb-4">
            <label for="address" class="block text-gray-700 font-bold mb-2">Adresse</label>
            <input type="text" name="address" id="address" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('address') }}">
        </div>
