...
<body>
    ...
    <p style="text-align: center; margin: 20px 0;">
        <a href="{{ url('/formation/inscription/' . $details['id'] . '/finaliser') }}" style="background-color: #1e88e5; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Finaliser mon inscription</a>
    </p>
