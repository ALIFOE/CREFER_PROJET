            ...
            <div class="bg-white rounded-lg max-w-md w-full p-6">
                ...
                <form action="{{ route('admin.gallery.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" class="w-full p-2 border rounded-md" rows="3"></textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer hover:border-blue-500 transition-colors duration-200">
                            ...
                            <label for="media" class="cursor-pointer">
                                ...
                                <p class="text-gray-600">Glissez et déposez votre fichier ici ou cliquez pour sélectionner</p>
                            </label>
    ...
    <script>
        ...
        function updateFileList(input) {
            ...
            if (input.files && input.files.length > 0) {
                const file = input.files[0]; // On ne prend que le premier fichier
