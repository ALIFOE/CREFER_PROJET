...
// Routes pour la gestion de la galerie (admin)
Route::middleware(['auth', 'admin'])->group(function () {
    Route::delete('/admin/gallery/{media}', [GalleryController::class, 'destroy'])->name('admin.gallery.destroy');
});
...
// Routes pour l'administration des médias
